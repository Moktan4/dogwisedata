...
%>
		<TR>
			...
			<TD><%
				...
				%><%
				if(!(rs.getString(6) == null || (rs.getString(6).equals(""))))%><%{%><%=rs.getString(6)%>
				<%
					}
				%>&nbsp; - &nbsp;<%=rs.getString(7)%></TD>
			<TD>
			<%
				...
				%>
				<%
				if(!(rs.getString(11) == null || (rs.getString(11).equals(""))))%><%{%><%=rs.getString(11)%>
					<%
					}
				%>
			...
			<%
				...
				%>
				<%
				if(!(rs.getString(14) == null || (rs.getString(14).equals(""))))%><%{%><%=rs.getString(14)%>
					<%
					}
				%>
			&nbsp; - &nbsp;<%=rs.getString(15)%></TD>
			...
			<%
				...
				%>
				<%
				if(!(rs.getString(27) == null || (rs.getString(27).equals(""))))%><%{%><%=rs.getString(27)%><br>
					<%
					}
				%>
				<%
				if(!(rs.getString(28) == null || (rs.getString(28).equals(""))))%><%{%><%=rs.getString(28)%>
					<%
					}
				%>
			</TD>
