...
<form >
	...
	<div class="form-group"> 
		...
		<input type="text" class="form-control" id="animal_id" name="animalID" placeholder="045678">
	</div>	

	<div class="form-group"> 
		<label for="animal_name" class="control-label">Animal Name</label>
		<input type="text" class="form-control" id="animal_name" name="animalName" placeholder="Animal Name">
	</div>					
	...
	<div class="form-group"> 
		...
		<input type="text" class="form-control" id="suiteroom_id" name="suiteroom" placeholder="###">
	</div>	
	<div class="form-group"><input id="input-file" name="input-file" type="file" class="file" data-show-preview="false"></div>	
	
	
	<div class="form-group"> 
		<button type="submit" class="btn btn-primary pull-right">Add Animal</button>
	</div>     
